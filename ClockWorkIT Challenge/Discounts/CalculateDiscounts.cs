...
namespace ClockWorkIT_Challenge
{
    public  class CalculateDiscounts
    {
        ...
        {
            int apples = 0;
            foreach (BasketItem b in basket) if (b.ProductID == 4) apples++;
             return apples;
        }
        ...
        {
            int bread = 0;
            foreach (BasketItem b in basket) if (b.ProductID == 2) bread++; 
            return bread;
        }
        ...
        {
            int soup = 0;
            foreach (BasketItem b in basket) if (b.ProductID == 1) soup++;
            return soup;
        }
    }
}
